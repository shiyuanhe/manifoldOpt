#ifndef EIGENREGUNSYM_CLASS
#define EIGENREGUNSYM_CLASS
...
/*
 ...
 (U, W, V): U,V Stiefel; W Positive Definite
 D = UWV^T
 */
class eigenRegUnsym : public manifold {
public:
  eigenRegUnsym(unsigned, unsigned, unsigned);
